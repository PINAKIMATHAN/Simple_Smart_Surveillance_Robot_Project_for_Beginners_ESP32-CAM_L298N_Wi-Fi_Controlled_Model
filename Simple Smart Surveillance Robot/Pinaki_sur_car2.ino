...
<html>
  ...
  <body class="noselect" align="center" style="background-color:white">
    <h1 style="color: teal;text-align:center;">Abhimanyu</h1>
    <h3 style="color: teal;text-align:center;">Integrated Surveillance and Exploration Rovers</h3>
    <h3 style="color: teal;text-align:center;">Made by Pinaki Shashishekhar Mathan</h3>
    <h3 style="color: teal;text-align:center;">OmDayal Group of Institutions, Uluberia</h3>
